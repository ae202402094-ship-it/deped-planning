...
<div class="max-w-5xl mx-auto px-4 mb-20 <?php echo e($isEmbed ? 'mt-4' : 'mt-10'); ?>">
    ...
    <form action="<?php echo e(route('public.schools')); ?>" method="GET" class="mb-8 bg-slate-100 p-3 rounded-2xl flex flex-col gap-3">
        <?php if($isEmbed): ?>
        ...
        <div class="relative w-full">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search school name or ID..." 
        ...
        <div class="flex flex-col md:flex-row gap-3">
            ...
            <select name="district" class="flex-1 bg-white border-none rounded-xl py-3.5 px-4 text-xs font-bold uppercase tracking-widest text-slate-600 focus:ring-2 focus:ring-red-800 shadow-sm outline-none cursor-pointer">
                ...
                ?>
                <?php $__currentLoopData = $uniqueDistricts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flex gap-2 shrink-0">
                ...
                <?php if(request()->filled('search') || request()->filled('sector') || request()->filled('level') || request()->filled('district')): ?>
                    <a href="<?php echo e(route('public.schools', $isEmbed ? ['embed' => 'true'] : [])); ?>" class="bg-slate-200 hover:bg-slate-300 text-slate-600 px-5 py-3.5 rounded-xl flex items-center justify-center transition-all shadow-sm" title="Clear Filters">
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-1.5 mt-2">
                                ...
                                <span class="px-2 py-0.5 bg-slate-100 text-slate-600 border border-slate-200 text-[8px] font-black uppercase tracking-widest rounded">
                                    <i class="bi bi-geo-alt-fill"></i> <?php echo e($school->district ?? 'No District'); ?>

                                </span>
                            </div>

                            <div class="md:hidden flex items-center gap-2 text-slate-400 mt-2">
                                <span class="text-[9px] font-black text-slate-400">ID: <?php echo e($school->school_id); ?></span>
                            </div>
                        </div>
                    </div>

                    <div class="shrink-0 mt-2 md:mt-0">
                        <a href="<?php echo e(route('public.view', ['id' => $school->id])); ?><?php echo e($isEmbed ? '?embed=true' : ''); ?>" 
    ...
    <div class="mt-8">
        <?php echo e($schools->appends(request()->query())->links()); ?>

    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\deped\example-app\resources\views/schools_list.blade.php ENDPATH**/ ?>