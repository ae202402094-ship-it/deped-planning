...
<head>
    ...
    <title><?php echo e($site_settings->header_title ?? 'DepEd Zamboanga City Division'); ?></title>
...
<body class="bg-slate-50 text-slate-900" x-data="{ mobileMenu: false }">
        ...
        <div class="container mx-auto px-4 py-3 md:py-6">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-2 md:gap-4 shrink-0">
                    <img src="<?php echo e(asset('images/deped.png')); ?>" alt="DepEd" class="h-10 sm:h-12 md:h-20 w-auto">
                    <img src="<?php echo e(asset('images/r9.png')); ?>" alt="Region IX" class="h-10 sm:h-12 md:h-20 w-auto">
                </div>
                ...
                <div class="hidden md:flex items-center gap-4 shrink-0">
                    <img src="<?php echo e(asset('images/ts.png')); ?>" alt="Transparency Seal" class="h-16 lg:h-20 w-auto opacity-90">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container mx-auto px-4">
            <div class="hidden sm:flex justify-center gap-4 md:gap-8">
                <a href="<?php echo e(route('public.map')); ?>" 
                   class="py-4 text-[10px] font-black uppercase tracking-widest border-b-2 transition-all <?php echo e(request()->routeIs('public.map') ? 'border-[#a52a2a] text-[#a52a2a]' : 'border-transparent text-slate-400 hover:text-[#a52a2a]'); ?>">
                    Interactive Map
                </a>
                <a href="<?php echo e(route('public.schools')); ?>" 
                   class="py-4 text-[10px] font-black uppercase tracking-widest border-b-2 transition-all <?php echo e(request()->routeIs('public.schools') ? 'border-[#a52a2a] text-[#a52a2a]' : 'border-transparent text-slate-400 hover:text-[#a52a2a]'); ?>">
                    School Directories
                </a>
            </div>
            ...
            <div class="sm:hidden flex justify-between items-center py-3">
                <span class="text-[10px] font-black uppercase text-slate-400 tracking-widest">
                    <?php echo e(request()->routeIs('public.map') ? 'Map View' : 'Registry'); ?>
            ...
            <div x-show="mobileMenu" 
                ...
                <a href="<?php echo e(route('public.map')); ?>" 
                   class="block py-3 text-[10px] font-black uppercase tracking-widest <?php echo e(request()->routeIs('public.map') ? 'text-[#a52a2a]' : 'text-slate-500'); ?>">
                    Map
                </a>
                
                <a href="<?php echo e(route('public.schools')); ?>" 
                   class="block py-3 text-[10px] font-black uppercase tracking-widest <?php echo e(request()->routeIs('public.schools') || request()->is('schools/*') ? 'text-[#a52a2a]' : 'text-slate-500'); ?>">
                    Directories
                </a>
            </div>
        </div>
    ...
    <main class="<?php echo e($isEmbed ? 'py-0' : 'py-10'); ?>">
    ...
    <footer class="bg-[#f2f2f2] text-gray-700 pt-10 pb-12 md:pt-16 md:pb-16 border-t border-gray-300 mt-auto relative" x-data="{ activeSection: null }">
        <div class="container mx-auto px-4 md:px-6 lg:px-20">
                        ...
                        <?php if(!empty($site_settings->footer_sections)): ?>
                            <?php $__currentLoopData = $site_settings->footer_sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="overflow-hidden transition-all md:max-h-none" :class="activeSection === 'sec'+<?php echo e($index); ?> ? 'max-h-60 pb-4' : 'max-h-0 md:mt-4'">
                                    <p class="text-[13px] text-gray-600"><?php echo e($section['content'] ?? ''); ?></p>
                                </div>
            ...
            <div class="container mx-auto px-4 mt-10 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-gray-400 hover:text-[#a52a2a] transition-colors flex items-center gap-2 text-[10px] font-black uppercase tracking-widest no-underline">
                    Portal Access
                </a>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\deped\example-app\resources\views/layouts/public.blade.php ENDPATH**/ ?>