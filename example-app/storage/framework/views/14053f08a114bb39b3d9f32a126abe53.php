...
<div class="print-only w-full bg-white text-black font-sans leading-tight">
    ...
    <div class="flex justify-between items-start border-b-[4px] border-double border-black pb-4 mb-6">
        <div class="flex items-center gap-4">
            <img src="<?php echo e(asset('images/deped.png')); ?>" class="h-24 w-auto" alt="DepEd Logo">
        ...
        <div class="text-right flex flex-col items-end">
            ...
            <p class="text-[10px] font-mono font-bold text-slate-800 uppercase leading-none">ID: <?php echo e($school->school_id); ?></p>
            <p class="text-[8px] font-mono text-slate-500 uppercase mt-1">Ref: <?php echo e(now()->format('Ymd-His')); ?></p>
        </div>
    </div>

    
    <div class="mb-6">
        <h2 class="text-2xl font-black uppercase tracking-tighter text-black"><?php echo e($school->name); ?></h2>
        <p class="text-xs font-bold text-slate-600 uppercase tracking-widest mt-1">
            <?php echo e($school->sector ?? 'Public'); ?> • <?php echo e($school->school_level ?? 'Unclassified'); ?> • <?php echo e($school->district ?? 'No District'); ?>
    ...
    <div class="print-border grid grid-cols-5 bg-slate-50 mb-6 text-center divide-x-2 divide-black">
        <div class="p-3">
            ...
            <p class="text-xl font-black tabular-nums"><?php echo e(number_format($school->no_of_teachers)); ?></p>
        </div>
        <div class="p-3">
            <p class="text-[9px] font-black uppercase tracking-widest text-slate-500 mb-1">Enrollees</p>
            <p class="text-xl font-black tabular-nums"><?php echo e(number_format($school->no_of_enrollees)); ?></p>
        </div>
        <div class="p-3">
            <p class="text-[9px] font-black uppercase tracking-widest text-slate-500 mb-1">Classrooms</p>
            <p class="text-xl font-black tabular-nums"><?php echo e(number_format($school->no_of_classrooms)); ?></p>
        </div>
        <div class="p-3">
            <p class="text-[9px] font-black uppercase tracking-widest text-slate-500 mb-1">Chairs</p>
            <p class="text-xl font-black tabular-nums"><?php echo e(number_format($school->no_of_chairs)); ?></p>
        </div>
        <div class="p-3">
            <p class="text-[9px] font-black uppercase tracking-widest text-slate-500 mb-1">Toilets</p>
            <p class="text-xl font-black tabular-nums"><?php echo e(number_format($school->no_of_toilets)); ?></p>
        </div>
    </div>
        ...
        <div>
            ...
            <div class="print-border p-4 space-y-3 text-sm font-bold uppercase">
                <div class="flex justify-between border-b border-slate-300 pb-1">
                    ...
                    <span class="text-black"><?php echo e($school->with_electricity); ?></span>
                </div>
                <div class="flex justify-between border-b border-slate-300 pb-1">
                    <span class="text-slate-600">Potable Water</span>
                    <span class="text-black"><?php echo e($school->with_potable_water ? 'YES' : 'NO'); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-600">Internet Access</span>
                    <span class="text-black"><?php echo e($school->with_internet ? 'YES' : 'NO'); ?></span>
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="print-border p-4 space-y-3 text-sm font-bold uppercase">
                <div class="flex justify-between border-b border-slate-300 pb-1">
                    ...
                    <span class="deped-red"><?php echo e(number_format($school->teacher_shortage ?? 0)); ?> Units (<?php echo e($school->teacher_ratio ?? 'N/A'); ?>)</span>
                </div>
                <div class="flex justify-between border-b border-slate-300 pb-1">
                    <span class="text-slate-600">Classrooms</span>
                    <span class="deped-red"><?php echo e(number_format($school->classroom_shortage ?? 0)); ?> Units (<?php echo e($school->classroom_ratio ?? 'N/A'); ?>)</span>
                </div>
                <div class="flex justify-between border-b border-slate-300 pb-1">
                    <span class="text-slate-600">Chairs</span>
                    <span class="deped-red"><?php echo e(number_format($school->chair_shortage ?? 0)); ?> Units (<?php echo e($school->chair_ratio ?? 'N/A'); ?>)</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-slate-600">Toilets</span>
                    <span class="deped-red"><?php echo e(number_format($school->toilet_shortage ?? 0)); ?> Units (<?php echo e($school->toilet_ratio ?? 'N/A'); ?>)</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="print-border p-4">
        <div class="flex justify-between items-center border-b-2 border-black pb-3 mb-3">
            <div>
                ...
                <span class="font-mono text-sm font-bold"><?php echo e($school->latitude ?? 'N/A'); ?>, <?php echo e($school->longitude ?? 'N/A'); ?></span>
            </div>
        </div>
        <div>
            ...
            <div class="flex flex-wrap gap-2">
                ...
                ?>
                <?php $__currentLoopData = $hazards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($h) && $h !== 'None'): ?>
                        <span class="print-border px-2 py-1 text-xs font-bold uppercase bg-slate-100"><?php echo e($h); ?></span>
                    <?php endif; ?>
...
<div class="no-print max-w-7xl mx-auto px-4 py-8 font-sans leading-tight text-slate-800 pb-32">
    ...
    <div class="flex flex-col md:flex-row justify-between items-stretch bg-white border-2 border-black mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-sm overflow-hidden">
        <div class="flex items-center flex-grow">
            ...
            <h1 class="px-6 text-xl font-black text-[#a52a2a] uppercase tracking-tight"><?php echo e($school->name); ?></h1>
        </div>
        <div class="flex border-t-2 md:border-t-0 md:border-l-2 border-black bg-slate-50 flex-wrap">
            ...
            <a href="<?php echo e(route('admin.schools')); ?>" class="flex-1 md:flex-none px-6 py-4 text-sm font-black uppercase text-slate-600 hover:text-black hover:bg-slate-200 transition-colors flex items-center justify-center gap-2">
                <i class="bi bi-x-square-fill"></i> Close
            </a>
        </div>
    </div>

    <form action="<?php echo e(route('schools.update', $school->id)); ?>" method="POST" id="editSchoolForm" class="space-y-8">
        <?php echo csrf_field(); ?>
            ...
            <div class="p-6 md:p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="school_id" value="<?php echo e($school->school_id); ?>" 
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e($school->name); ?>" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t-2 border-slate-100">
                    <div>
                        ...
                        <select name="sector" class="w-full bg-white border-2 border-slate-300 p-3 text-sm font-bold uppercase focus:outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm shadow-inner">
                            <option value="Public" <?php echo e(($school->sector ?? '') == 'Public' ? 'selected' : ''); ?>>Public School</option>
                            <option value="Private" <?php echo e(($school->sector ?? '') == 'Private' ? 'selected' : ''); ?>>Private School</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="school_level" class="w-full bg-white border-2 border-slate-300 p-3 text-sm font-bold uppercase focus:outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm shadow-inner">
                            ...
                            <option value="Primary" <?php echo e(($school->school_level ?? '') == 'Primary' ? 'selected' : ''); ?>>Primary (Elementary)</option>
                            <option value="Secondary" <?php echo e(($school->school_level ?? '') == 'Secondary' ? 'selected' : ''); ?>>Secondary (High School)</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="district" class="w-full bg-white border-2 border-slate-300 p-3 text-sm font-bold uppercase focus:outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm shadow-inner">
                            ...
                            <?php $__currentLoopData = $commonDistricts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dist); ?>" <?php echo e($currentDistrict == $dist ? 'selected' : ''); ?>><?php echo e($dist); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="bg-slate-50 border-2 border-slate-200 p-6 rounded-sm mt-6">
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-6">
                        <?php $__currentLoopData = [['name' => 'no_of_teachers', 'label' => 'Teachers'], ['name' => 'no_of_enrollees', 'label' => 'Enrollees'], ['name' => 'no_of_classrooms', 'label' => 'Classrooms'], ['name' => 'no_of_chairs', 'label' => 'Chairs'], ['name' => 'no_of_toilets', 'label' => 'Toilets']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label class="block text-xs font-black text-slate-500 uppercase mb-2 tracking-widest"><?php echo e($field['label']); ?></label>
                            <input type="number" name="<?php echo e($field['name']); ?>" id="input_<?php echo e($field['name']); ?>" value="<?php echo e($school->{$field['name']}); ?>" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 divide-y-2 lg:divide-y-0 lg:divide-x-2 divide-slate-100 border-black">
                ...
                <div class="p-6 md:p-8 space-y-6 bg-white border-r-0 lg:border-r-2 border-black">
                    ...
                    <div>
                        ...
                        <select name="with_electricity" class="w-full bg-slate-50 border-2 border-slate-300 text-slate-800 text-sm font-bold uppercase p-3 outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm">
                            <option value="None" <?php echo e($school->with_electricity == 'None' ? 'selected' : ''); ?>>No Electricity (Off-Grid)</option>
                            <option value="Grid Connection" <?php echo e($school->with_electricity == 'Grid Connection' ? 'selected' : ''); ?>>Direct Grid Connection</option>
                            <option value="Solar Powered" <?php echo e($school->with_electricity == 'Solar Powered' ? 'selected' : ''); ?>>Solar / Renewable (Off-Grid)</option>
                            <option value="Generator" <?php echo e($school->with_electricity == 'Generator' ? 'selected' : ''); ?>>Generator Set Only</option>
                            <option value="Hybrid" <?php echo e($school->with_electricity == 'Hybrid' ? 'selected' : ''); ?>>Hybrid (Grid + Solar)</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="with_potable_water" class="w-full bg-slate-50 border-2 border-slate-300 text-slate-800 text-sm font-bold uppercase p-3 outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm">
                                <option value="1" <?php echo e($school->with_potable_water ? 'selected' : ''); ?>>YES</option>
                                <option value="0" <?php echo e(!$school->with_potable_water ? 'selected' : ''); ?>>NO</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="with_internet" class="w-full bg-slate-50 border-2 border-slate-300 text-slate-800 text-sm font-bold uppercase p-3 outline-none focus:border-black focus:bg-white cursor-pointer transition-colors rounded-sm">
                                <option value="1" <?php echo e($school->with_internet ? 'selected' : ''); ?>>YES</option>
                                <option value="0" <?php echo e(!$school->with_internet ? 'selected' : ''); ?>>NO</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8 bg-slate-50/50">
                    ...
                    <div class="space-y-4">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $short): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white border-2 border-black p-4 rounded-sm shadow-sm">
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <span class="text-sm font-black text-slate-700 uppercase tracking-tight"><?php echo e($short['label']); ?></span>
                                <div class="flex gap-2">
                                    <div class="flex-1">
                                        <label class="block text-[9px] font-black text-slate-400 uppercase mb-1">Manual Ratio</label>
                                        <input type="text" name="<?php echo e($short['name']); ?>_ratio" value="<?php echo e($school->{$short['name'].'_ratio'} ?? ''); ?>" 
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="number" name="<?php echo e($short['name']); ?>_shortage" value="<?php echo e($school->{$short['name'].'_shortage'} ?? 0); ?>" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 divide-y-2 lg:divide-y-0 lg:divide-x-2 divide-slate-100 border-black">
                <div class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" step="any" name="latitude" id="lat" value="<?php echo e($school->latitude); ?>" 
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="longitude" id="lng" value="<?php echo e($school->longitude); ?>" 
                                   oninput="updateMapFromInputs()" 
                                   class="w-full bg-white border-2 border-slate-300 p-2 font-mono text-sm text-center font-bold outline-none focus:border-black rounded-sm">
                        </div>
                    </div>
                ...
                <div class="p-6 md:p-8 bg-slate-50/50 flex flex-col">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
                        <?php $__currentLoopData = $defaultHazardsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hazard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-3 p-4 border-2 border-slate-300 cursor-pointer hover:border-black hover:bg-slate-50 transition-all bg-white has-[:checked]:border-[#a52a2a] has-[:checked]:shadow-[2px_2px_0px_0px_rgba(165,42,42,1)] group">
                            <input type="checkbox" name="hazard_type[]" value="<?php echo e($hazard); ?>" <?php echo e(in_array($hazard, $currentHazards) ? 'checked' : ''); ?> 
                            ...
                            <span class="text-xs font-black text-slate-700 uppercase tracking-tight group-hover:text-black has-[:checked]:text-[#a52a2a] transition-colors"><?php echo e($hazard); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="border-t-2 border-black pt-5">
                        ...
                        <div id="custom_hazards_wrapper" class="space-y-3">
                            <?php $__currentLoopData = $customHazards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-3">
                                <input type="text" name="custom_hazards[]" value="<?php echo e($custom); ?>" class="flex-1 border-2 border-black bg-white text-xs font-bold text-black uppercase focus:outline-none focus:bg-[#fdf2f2] p-3 transition-all" placeholder="E.g., Wildfire Zone">
    ...
    <div class="bg-white border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full max-w-md overflow-hidden rounded-sm">
        ...
        <div class="p-6 md:p-8 bg-white">
            ...
            <div class="bg-red-50 border border-red-200 p-3 rounded-sm mb-8">
                <span class="font-black text-red-700 uppercase tracking-tight"><?php echo e($school->name); ?></span>
            </div>
            
            <form action="<?php echo e(route('schools.destroy', $school->id)); ?>" method="POST" class="flex gap-4">
                <?php echo csrf_field(); ?> 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        setTimeout(() => {
            ...
            }).setView([<?php echo e($school->latitude ?? 6.9214); ?>, <?php echo e($school->longitude ?? 122.0739); ?>], 15);
            ...
            editMarker = L.marker([<?php echo e($school->latitude); ?>, <?php echo e($school->longitude); ?>], {
                icon: L.divIcon({ 
...
<?php echo $__env->make('admin.partials.map_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\deped\example-app\resources\views/admin/edit_school.blade.php ENDPATH**/ ?>